...
class PdfFile:
    ...
    async def parse(self):
        ...
        file_name = f'{os.getcwd()}/banks/ozon/data/{uuid.uuid4()}.pdf'
        with open(file_name, "wb") as file:
            file.write(response.content)
        await asyncio.sleep(1)
        self.titles.append("Тарифы «Ozon Счёт для бизнеса»")
    ...
    async def compare(self):
        ...
        changes_from_db = await AsyncORM.select_changes_for_compare(
            bank=Banks.ozon, typechanges=TypeChanges.pdf_file, lim=4)
